...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/admin/upload"             //图片上传提交地址
        ...
        //涂鸦图片配置区
        ,scrawlUrl:"/admin/upload"           //涂鸦上传地址
        ,scrawlPath:URL+"php/"                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:"/admin/upload"               //附件上传提交地址
        ,filePath:""                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:"/admin/upload"   //处理远程图片抓取的地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:"/admin/upload"       //图片在线管理的处理地址
        ...
        //word转存配置区
        ,wordImageUrl:"/admin/upload"             //word转存提交地址
        ...
        , toolbars: [["fullscreen","source","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","selectall","|","insertimage","horizontal","blockquote","spechars","insertcode","bold","italic","underline","strikethrough","forecolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable","deletetable","removeformat"]]
...
//        }
        ...
        ,initialFrameWidth:880   //初始化编辑器宽度,默认1000
        ,initialFrameHeight:580  //初始化编辑器高度,默认320
